#ifndef DASH_CXX_HEADERS_H
#define DASH_CXX_HEADERS_H
...
typedef struct Switching {
    int interval_ = 0;
    // the interval between two switching points in the scale of the @timescale on Representation level.
...
typedef struct CommonAttribute {
